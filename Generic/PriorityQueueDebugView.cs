...
namespace System.Collections.Generic
{
    ...
    {
        private readonly Ai2_Genetic_Algorithm.Generic.PriorityQueue<TElement, TPriority> _queue;
        private readonly bool _sort;

        public PriorityQueueDebugView(Ai2_Genetic_Algorithm.Generic.PriorityQueue<TElement, TPriority> queue)
        {
        ...
        public PriorityQueueDebugView(Ai2_Genetic_Algorithm.Generic.PriorityQueue<TElement, TPriority>.UnorderedItemsCollection collection)
        {
